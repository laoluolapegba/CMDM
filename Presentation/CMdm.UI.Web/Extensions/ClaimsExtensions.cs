...
namespace CMdm.UI.Web.Extensions
{
    public static class ClaimsExtensions
    {
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "CMdm.UI.Web.Models.RegisterViewModel.Email")?.Value;
        }
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "CMdm.UI.Web.Models.RegisterViewModel.NameIdentifier")?.Value;
        }
