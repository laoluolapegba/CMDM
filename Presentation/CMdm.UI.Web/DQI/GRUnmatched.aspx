<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GRUnmatched.aspx.cs" Inherits="Cdma.Web.DQI.GRUnmatched" %>
            ...
            <div class="widget">
                ...
                <div class="widget-content">
                    ...
                    <asp:SqlDataSource ID="dsgoldenrec" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringCDMA %>"
                        ...
                        SelectCommand=" select BVN_KEY,BVN,CUST_FIRST_NAME,CUST_MIDDLE_NAME,CUST_LAST_NAME,MINOR_FLAG,PHONE,EMAIL,DOB,GENDER,KOUNT from uba_golden_view_bvn where bvn is null "></asp:SqlDataSource>
