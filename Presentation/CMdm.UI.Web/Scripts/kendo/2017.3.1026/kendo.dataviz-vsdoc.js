...
$.fn.kendoBingLayer = function(options) {
    ...
    /// &#10;The Bing API end-point. The creator of the workbook.
    /// &#10;
...
$.fn.kendoMarker = function(options) {
    ...
    /// &#10;The marker shape. The following pre-defined marker shapes are available: pinTarget or pin. Marker shapes are implemented as CSS classes on the marker element (span.k-marker). For example "pinTarget" is rendered as "k-marker-pin-target".
    /// &#10;
