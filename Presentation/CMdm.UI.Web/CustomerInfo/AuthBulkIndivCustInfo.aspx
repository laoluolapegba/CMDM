<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AuthBulkIndivCustInfo.aspx.cs" Inherits="Cdma.Web.CustomerInfo.AuthBulkIndivCustInfo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="widget">
        <div class="widget-header">
            <h3><i class="fa fa-edit"></i>Authorize Bulk Individual Customer Information</h3>
        </div>
    ...
    <table class="nav-justified">
        ...
        <tr>
            ...
            <div class="widget widget-table">
											<div class="widget-header">
												<h3><i class="fa fa-table"></i> View Individual Customer Information</h3>
											</div>
											<div class="widget-content">
                ...
                <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="CUSTOMER_ID" DataNavigateUrlFormatString="~/CustomerInfo/BulkUploadDetails.aspx?prc=prc_individual_approval_url&CUSTOMER_ID={0}" 
