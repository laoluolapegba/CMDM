...
{
    public partial class AuthBulkCorpCustInfo : System.Web.UI.Page
    {
        ...
        protected void btnSearchMaker_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandText = "pkg_cdms2.prc_corp_customer_per_maker";
        ...
        private int ProcessRequest(Int32 CustomerID, string status)
        {
            ...
            try
            {
                ...
                cmd.Connection = con;
                cmd.CommandText = "pkg_cdms2.prc_corp_customer_bulk_approve";//prc_basic_bulk_approve 
