<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AuthBulkBasicCustInfo.aspx.cs" Inherits="Cdma.Web.CustomerInfo.AuthBulkBasicCustInfo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="widget">
        <div class="widget-header">
            <h3><i class="fa fa-edit"></i>Authorize Bulk Basic Customer Information</h3>
        </div>
            ...
            <div class="widget widget-table">
                ...
                <asp:GridView ID="GridView2" runat="server" AllowPaging="True" AllowSorting="True"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="CUSTOMER_ID" DataNavigateUrlFormatString="~/CustomerInfo/BulkUploadDetails.aspx?prc=prc_basic_details_approval_url&CUSTOMER_ID={0}" 
