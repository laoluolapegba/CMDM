...
namespace CMdm.UI.Web.Controllers
{
    public class CustomerController : Controller
    {
        ...
        public ActionResult Details(string id)
        {
            ...
            cDMA_INDIVIDUAL_IDENTIFICATION cDMA_INDIVIDUAL_BIO_DATA = db.CDMA_INDIVIDUAL_BIO_DATA.Find(id);
        ...
        public ActionResult Create([Bind(Include = "CUSTOMER_NO,TITLE,SURNAME,FIRST_NAME,OTHER_NAME,NICKNAME_ALIAS,DATE_OF_BIRTH,PLACE_OF_BIRTH,COUNTRY_OF_BIRTH,SEX,AGE,MARITAL_STATUS,NATIONALITY,STATE_OF_ORIGIN,MOTHER_MAIDEN_NAME,DISABILITY,COMPLEXION,NUMBER_OF_CHILDREN,RELIGION,CREATED_DATE,CREATED_BY,LAST_MODIFIED_DATE,AUTHORISED,AUTHORISED_BY,AUTHORISED_DATE,IP_ADDRESS,BRANCH_CODE")] cDMA_INDIVIDUAL_IDENTIFICATION cDMA_INDIVIDUAL_BIO_DATA)
        {
